...
//     - **marshalr**: a function f(message): Buffer
...
//     - **compress**: can take the value 'gzip' or 'deflate'
//     - **unmarshal**: a function f(Buffer): object
...
// Allow .marshal to set the marshaller on the EncodingStream
Object.defineProperty(
  EncodingStream.prototype,
  "marshal", {
...
// Allow .unmarshal to set the unmarshaller on the DecodingStream
Object.defineProperty(
  DecodingStream.prototype,
  "unmarshal", {
...
/**
 * removeBinValues transforms a key value pair to one where the value
 * is base64 encoded if necessary.
 *
 * @param key the key
 * @parm  value the value that may be Buffer or non-ascii
 */
