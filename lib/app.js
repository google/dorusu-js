 ...
 * @param {function} [marshaller] marshals the response to a `Buffer`
 * @param {function} [unmarshaller] unmarshals the request from a `Buffer`
 * @constructor
 */
...
/**
 * A Service describes a group of rpc handlers that are to be available on a rpc
 * server.
 *
